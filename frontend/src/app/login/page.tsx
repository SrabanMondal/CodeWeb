...
export default function LoginPage() {
  ...
  return (
    <div className="flex h-screen w-full overflow-hidden">
      ...
      <div className="relative bg-emerald-600 w-1/2 h-full">
      <div style={{borderTopRightRadius:'250px 450px'}} className="w-full h-full bg-white flex justify-center items-center">
        <div className="inset-0 flex flex-col items-center justify-center px-8 sm:px-12">
          <h1 className="mb-2 text-4xl font-bold text-emerald-700">welcome</h1>
          <p className="mb-10 text-2xl text-gray-700">Login in to your account to continue</p>

          <div className="w-full max-w-lg space-y-4">
            <div className="rounded-full bg-emerald-100 px-6 py-3">
              <input type="email" value={email} onChange={(e)=>setemail(e.target.value)} placeholder="Email" className="w-full text-black bg-emerald-100 outline-none" />
            </div>
           ...
           {/*
            ...
            <button onClick={handleLogin} className="w-full rounded-full bg-emerald-500 py-3 font-medium text-white transition hover:bg-emerald-600">
              LOG IN
            </button>
            {/*
